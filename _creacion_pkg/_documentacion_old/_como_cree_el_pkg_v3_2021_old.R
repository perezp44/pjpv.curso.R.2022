#- Es como la bitacora de pjpv.datos.2021.01

#- 2021/04/08: voy a volver a hacer un R pkg y esto es lo que hice:
...
#- AHORA 2021 lei esto: https://happygitwithr.com/credential-caching.html#credential-caching
#- hice lo de la two-factor authentification en Github
#- y ahora estoy intentando crear un github access token
usethis::create_github_token()

#- te lleva a Github y te da un token
#- para registrar el token hay 2 metodos segun Jenny:
gitcreds::gitcreds_set(url = "https://github.com") #- me pide el token o la contraseña. Pongo el TOKEN y estoy DONE
credentials::set_github_pat()

#- me dio jaleo x Linux: https://unix.stackexchange.com/questions/520341/ssh-installed-but-i-get-the-error-failed-to-start-ssh-service-unit-ssh-service
# $ sudo apt-get install openssh-server
#- despues de instalar sshservice, tuve que: https://askubuntu.com/questions/1252596/unable-to-ssh-to-a-local-system-error-publickey-password-ssh-key-regenerati
#- creo q al final lo tengo bien pero no me funciona

#- este era el error q me daba
# Found git version 2.25.1
# Supported HTTPS credential helpers: cache, store
# Found OpenSSH_8.2p1 Ubuntu-4ubuntu0.2, OpenSSL 1.1.1f  31 Mar 2020
# No key found. Use ssh_keygen() to generate one!


# 3) Una vez RStudio se haya reiniciado, ejecutas en la CONSOLA: usethis::use_github()  . Te preguntará que qué git protocol quieres usar. Selecciona https. Te preguntará si la Description está OK. Le dices que SI. Se creará el repo en Github y añadirá el remote origin y alguna cosa mas y lo dejará casí niquelado.
usethis::use_github() #- ESTO NO ME FUNCIONA


#- como no me funcionaba usethis::use_github()
#- entonces tb he puesto en .REnviron el GITHUB_PAT, pero sigue sin funcionar el usethis::use_github()

#- asi que como no me funciona el usethis::use_github(). He decidio hacerlo a mano:

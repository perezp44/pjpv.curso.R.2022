#' @title Crea un resumen de un data.frame.
#' @description Para cada variable del df calcula: número y porcentaje de valores cero (q_zeros and p_zeros respectevly). Same metrics for NA values (q_NA and p_na). Last two columns indicates data type and quantity of unique values.
...
pjp_estadisticos_basicos <- function(data, print = FALSE) {
